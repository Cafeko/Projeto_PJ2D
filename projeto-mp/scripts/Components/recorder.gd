...
# ---------------------------------------------------------------------------- #
# --- On Signal -------------------------------------------------------------- #
# Quando o tempo de gravação acabar remove e apaga a ultima recording tape.
